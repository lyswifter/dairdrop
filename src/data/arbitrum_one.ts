export let StepTaskData = [{
    ...
    imgs: [{
        ...
        url: "https://cionhere.net/airdrops/arbitrumone_1.png",
        srcList: [
            'https://cionhere.net/airdrops/arbitrumone_1.png',
        ],
    },
     ],
    isFulfilled: false,
    ...
    subSteps: [{
        ...
        imgs: [{
            ...
            url: "https://cionhere.net/airdrops/arbitrumone_2.1.png",
            srcList: [
                'https://cionhere.net/airdrops/arbitrumone_2.1.png',
            ],
        },
         ],
        isVerify: true,
        ...
        imgs: [{
            ...
            url: "https://cionhere.net/airdrops/arbitrumone_2.2_1.png",
            srcList: [
                'https://cionhere.net/airdrops/arbitrumone_2.2_1.png',
            ],
        },{
            name: "arbitrumone_2.2_2.png",
            url: "https://cionhere.net/airdrops/arbitrumone_2.2_2.png",
            srcList: [
                'https://cionhere.net/airdrops/arbitrumone_2.2_2.png',
            ],
        }],
        isVerify: true, 
    }]
